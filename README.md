...
| LAO | Limited Access Offender | | An offender whose data is subject to user-specific access restrictions, where viewing permissions are determined against a variety of factors.  This could include the relationship between the individual user and the particular offender (e.g. exclude staff with familial ties), or it could include restricting access to an  offenders involved in high-profile cases. |
